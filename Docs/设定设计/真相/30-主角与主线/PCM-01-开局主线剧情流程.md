...
本条载**已拍板**的开局主线：自 **B-9002** 苏醒，至**简历工作区**、**常驻委托（人事组）**解锁为止的**节点顺序**、**类型**（教程／任务内／解锁）及**叙述要点**。台词、关卡与 UI 归 [叙事生产稿/](../../叙事生产稿/README.md)；制度与前史分别见 [SYS-B9002](../10-百科/系统/SYS-B9002-桥与玩家职能.md)、[TIM-04](../40-时序与历史/TIM-04-前任管理员执政与第九区事态背景年表.md)。长期压力与终局服从 [NAR-01](../20-叙事规范/NAR-01-主线张力与终局分型.md)。

**不含**：反 AI 游行等（归档 [引导任务与反AI游行支线_转写稿](../../叙事生产稿/99-归档/2026-06-历史草稿迁入/引导任务与反AI游行支线_转写稿.md)，**未拍板**）；前任管理员／部长 P2–P3 线（非开局必经）。
