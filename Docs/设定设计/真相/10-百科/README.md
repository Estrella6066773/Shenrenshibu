...
条目之间的逻辑关系，以正文互引以及 [管理规则/id-registry.yaml](../../管理规则/id-registry.yaml) 中的登记为准。世界基石条文见 [真相/00-基石/](../00-基石/)。叙事取向与红线见叙事规范 [NAR-00](../20-叙事规范/NAR-00-叙事母题与基调.md)、[NAR-01](../20-叙事规范/NAR-01-主线张力与终局分型.md)、[NAR-02](../20-叙事规范/NAR-02-玩家责任与叙事红线.md)；总览见 [叙事规范 README](../20-叙事规范/README.md)。
...
| [ORG-TECHDEPT](组织/赫利俄斯/ORG-TECHDEPT-科学技术管理部.md) | 科学技术管理部（通称科技部） |
...
| [ORG-MOV-BRIDGECULT](组织/ORG-MOV-BRIDGECULT-联结会.md) | 联结会（前任管理员隐秘追随网络） |
...
| [ENT-FAITH-NINTH](文化/ENT-FAITH-NINTH-第九区民间信仰生态.md) | 第九区民间信仰生态（萨满教、造主教与分支） |
