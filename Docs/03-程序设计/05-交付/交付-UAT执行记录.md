...
| 最后更新 | 2026-06-29（结构优化后静态验收：路径迁移、链检、预检、数据资产、日常委托场景） |
...
| **预检总表** | `python Docs/03-程序设计/05-交付/verify-uat-preflight.py` | **通过** | 2026-06-14 |
| **结构迁移检查** | `python Scripts/migrate-docs-paths.py --check` | **通过** | 2026-06-29 |
| **设定链接检查** | `python Docs/04-设定/工具/检查/check-links.py` | **通过** | 2026-06-29 |
| **预检总表** | `python Docs/03-程序设计/05-交付/verify-uat-preflight.py` | **通过** | 2026-06-29 |

| UAT-036a | `python Docs/03-程序设计/05-交付/verify-assignment-daily-scene.py` | **通过** | 2026-06-14 |
| UAT-036a | `python Docs/03-程序设计/05-交付/verify-assignment-daily-scene.py` | **通过** | 2026-06-29 |
...
| UAT-115 | `python Docs/03-程序设计/05-交付/verify-uat-data-assets.py` | **通过** | 2026-06-14 |
| UAT-115 | `python Docs/03-程序设计/05-交付/verify-uat-data-assets.py` | **通过** | 2026-06-29 |
...
| **batch** | `powershell -File Docs/03-程序设计/05-交付/run-uat036-tests.ps1`（须先关闭占用本工程的 Unity 实例） |

| **GUI 触发** | `powershell -File Docs/03-程序设计/05-交付/request-uat036-gui-run.ps1`（Editor 已打开时；读 `Temp/uat036-run.result`） |
